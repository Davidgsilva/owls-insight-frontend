...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "WebSocket (2 connections, unlimited messages)",
      "Everything in Bench",
      "Player props access",
    ],
    cta: "Get Started",
  ...
  },
  {
    ...
    features: [
      ...
      "WebSocket (5 connections, unlimited messages)",
  ...
  },
  {
    ...
    features: [
      ...
      "1,000 REST requests/minute burst",
      "WebSocket (20 connections, unlimited messages)",
